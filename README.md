...
| RTX 4090 24GB | 47.6 | 87.1 | 2 | — | openclaw |
...
\* RTX 4090 row: Qwen3.8-27B-Purusha GGUF (q4_K_M), 131K context, q4_0 KV cache, llama-server stock build, Linux/CUDA, Ryzen 7 9800X3D, ngl 999, flash attention on, --parallel 1. Method: stock probe.py, 3 runs × 3 prompts, thinking off. Acceptance not captured; speed delta is the durable part.
